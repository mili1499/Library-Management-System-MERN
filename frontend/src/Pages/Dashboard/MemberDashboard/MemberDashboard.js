   ...
   return (
      <div className="dashboard">
         <div className="dashboard-card">
            ...
            <div
               className={
                  sidebar ? "dashboard-options active" : "dashboard-options"
               }
            >
               ...
               >
                  <AccountCircleIcon className="dashboard-option-icon" />{" "}
                  Profile
               </a>
               <a
               ...
               >
                  <PowerSettingsNewIcon className="dashboard-option-icon" /> Log
                  out{" "}
               </a>
            </div>
